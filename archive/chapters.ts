namespace CCTJ {
    function choiceA(label: string, unlocked: boolean, crossed: boolean): ChoiceOption {
    ...
    export function playChapter1() {
        ...
        if (!r1) {
            ...
            if (pickA == 0) {
                showLines([
                    "BUSHNELL: Something is missing, if you ask me."
                ])
            }
            return
        }
        ...
        if (pickB == 1) {
            showLines([
                "BUSHNELL: Angles and reflections! That changes everything."
            ])
        }
        ...
        if (pickC == 2) {
            showLines([
                "BUSHNELL: Now we are talking tennis!"
            ])
        }
    ...
    export function playChapter2() {
        ...
        if (!r1) {
            ...
            if (pickA == 0) {
                showLines([
                    "IWATANI: Hm. I think it still needs more life."
                ])
            }
            return
        }
        ...
        if (pickB == 1) {
            showLines([
                "IWATANI: Turn the hunter into the hunted!"
            ])
        }
        ...
        if (pickC == 2) {
            showLines([
                "IWATANI: Different behaviors and style. Perfect!"
            ])
        }
    ...
    export function playChapter3() {
        ...
        if (!r1) {
            ...
            if (pickA == 0) {
                showLines([
                    "PAJITNOV: Maybe I should return to my normal work."
                ])
            }
            return
        }
        ...
        if (pickB == 1) {
            showLines([
                "PAJITNOV: Four squares each... only seven shapes!"
            ])
        }
        ...
        let pickC = chooseIdea(
            ...
            [
                choiceA("A: It seems fine.", false, true),
                choiceA("B: Simpler shapes", false, true),
                choiceA("C: Clear full rows", true, false)
            ]
        )
        if (pickC == 2) {
            showLines([
                "PAJITNOV: Yes. Full rows should disappear!"
            ])
        }
